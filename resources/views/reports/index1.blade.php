...
if($po->ENTITYCODE=='01-234-001'){
	$comp = "ESRNL";
}elseif($po->ENTITYCODE=='01-234-002'){
	$comp = "NPRNL";
...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header text-primary text-center">Enter New Report Data</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
{!! Form::open(['action' => 'DailyreportController@store']) !!}	
 ...
 <div class="row">
				...
				<div id="div_id_select" class="form-group required"  style="margin-bottom:10px">
						<label for="id_select"  class="control-label col-md-2  requiredField">Product Name<span class="asteriskField">*</span></label>
						<div class="controls col-md-6" >
						{!! Form::text('prodName',$po->ITEMNAME,array('class' => 'input-md form-control', 'required', 'readonly')); !!} 
						</div>				
				</div>		
				<div id="div_id_select" class="form-group required">
						<label for="id_select"  class="control-label col-md-2  requiredField">Company<span class="asteriskField">*</span></label>
						<div class="controls col-md-2"  style="margin-bottom:10px">
						{!! Form::text('company',$comp,array('class' => 'input-md form-control', 'required', 'readonly')); !!} 
						</div>				
				</div>					
				<div id="div_id_select" class="form-group required">
						<label for="id_select"  class="control-label col-md-2  requiredField">Production  Order<span class="asteriskField">*</span></label>
						<div class="controls col-md-2"  style="margin-bottom:10px">
						{!! Form::text('prodOrder',$po->PROD_NUMBER,array('class' => 'input-md form-control', 'required', 'readonly')); !!} 
						</div>				
				</div>								
				<div id="div_id_select" class="form-group required">
...
<hr style="width: 100%; color: black; height: 1px;" class="text-primary" />	
						...
						{!! Form::number('labAM',"",array('class' => 'input-md form-control','step'=>0.001, 'id'=>'name', 'min'=>1, 'max'=>100)); !!} 
						...
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom: 10px">
						{!! Form::number('labDensity',"",array('class' => 'input-md form-control', 'id'=>'username','step'=>0.001, 'max'=>0.9999)); !!}
...
<hr style="width: 100%; color: black; height: 1px;" class="text-primary" />						
						...
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom:10px">
						{!! Form::number('caustic',"",array('class' => 'input-md form-control', 'id'=>'name', 'step'=>0.001, 'max'=>15)); !!} 
						...
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom:10px">
						{!! Form::number('baume',"",array('class' => 'input-md form-control', 'id'=>'name', 'step'=>0.0001, 'min'=>1, 'max'=>20)); !!} 
	...
	<hr style="width: 100%; color: black; height: 1px;" class="text-primary" />	
						...
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom:10px">
						{!! Form::number('SlurryAM',"",array('class' => 'input-md form-control', 'id'=>'name', 'step'=>0.0001, 'min'=>1, 'max'=>90)); !!} <span>range:1-90</span>
						</div>								
					</div>	
						<div id="div_id_select" class="form-group required">
...
<hr style="width: 100%; color: black; height: 1px;" class="text-primary" />	
						...
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom:10px">
						{!! Form::number('bpAM',"",array('class' => 'input-md form-control', 'id'=>'name','step'=>0.001 ,'min'=>1, 'max'=>90)); !!} 
						...
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom:10px">
						{!! Form::number('bpBD',"",array('class' => 'input-md form-control', 'id'=>'name',  'step'=>0.0001,'max'=>1)); !!} <span>range:0.01-1</span>
						</div>			
					</div>									
...
<hr style="width: 100%; color: black; height: 1px;"/>	
						...
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom:10px">
						{!! Form::number('fpBD',"",array('class' => 'input-md form-control', 'id'=>'name',  'step'=>0.0001,  'max'=>1)); !!} <span>range:0.01-1</span>
						</div>	
					</div>				
						<div id="div_id_select" class="form-group required">
						...
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom:10px">
						{!! Form::number('fpAM',"",array('class' => 'input-md form-control', 'id'=>'name', 'step'=>0.001,  'min'=>1, 'max'=>100)); !!} <span>range:1-90</span>
						</div>							
					</div>				
						<div id="div_id_select" class="form-group required">
						<label for="id_select"  class="control-label col-md-5  requiredField">FP %Water (H20)<span class="asteriskField"></span></label>
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom:10px">
						{!! Form::number('fpWater',"",array('class' => 'input-md form-control', 'id'=>'name', 'step'=>0.001,  'min'=>1, 'max'=>100)); !!} <span>range:1-90</span>
						</div>							
					</div>				
						<div id="div_id_select" class="form-group required">
						<label for="id_select"  class="control-label col-md-5  requiredField">FP PH<span class="asteriskField"></span></label>
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom:10px">
						{!! Form::number('fpPH',"",array('class' => 'input-md form-control', 'id'=>'name', 'step'=>0.001,  'min'=>1, 'max'=>100)); !!} <span>range:1-90</span>
						</div>							
					</div>	
