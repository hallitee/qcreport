...
<hr style="width: 100%; color: black; height: 1px;" class="text-primary" />	
						...
						{!! Form::number('labAM',$po->labAM,array('class' => 'input-md form-control','step'=>0.001, 'id'=>'name', 'min'=>1, 'max'=>100, 'readonly')); !!} 
						...
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom: 10px">
						{!! Form::number('labDensity',$po->labDensity,array('class' => 'input-md form-control', 'id'=>'username','step'=>0.001, 'max'=>0.9999, 'readonly')); !!}
...
<hr style="width: 100%; color: black; height: 1px;" class="text-primary" />						
						...
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom:10px">
						{!! Form::number('caustic',$po->caustic,array('class' => 'input-md form-control', 'id'=>'name', 'step'=>0.001, 'max'=>15, 'readonly')); !!} 
						...
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom:10px">
						{!! Form::number('baume',$po->baume,array('class' => 'input-md form-control', 'id'=>'name', 'step'=>0.0001, 'min'=>1, 'max'=>20, 'readonly')); !!} 
	...
	<hr style="width: 100%; color: black; height: 1px;" class="text-primary" />	
						...
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom:10px">
						{!! Form::number('SluryConc',$po->slurryConc,array('class' => 'input-md form-control', 'id'=>'name', 'min'=>1, 'max'=>90, 'readonly')); !!} <span>range:1-90</span>
						</div>								
					</div>
						<div id="div_id_select" class="form-group required">
						<label for="id_select"  class="control-label col-md-5  requiredField">Slurry %AM<span class="asteriskField"></span></label>
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom:10px">
						{!! Form::number('SlurryAM',$po->slurryAM,array('class' => 'input-md form-control', 'id'=>'name', 'step'=>0.0001, 'min'=>1, 'max'=>90, 'readonly')); !!} <span>range:1-90</span>
						</div>								
					</div>	
						<div id="div_id_select" class="form-group required">
...
<hr style="width: 100%; color: black; height: 1px;" class="text-primary" />	
						...
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom: 10px">
						{!! Form::number('bpGran',$po->bpGranular,array('class' => 'input-md form-control', 'id'=>'email', 'max'=>5, 'readonly')); !!}<span>range:1-5 </span>
						</div>	
					</div>
						<div id="div_id_select" class="form-group required">
						<label for="id_select"  class="control-label col-md-5  requiredField">Base Powder %AM<span class="asteriskField"></span></label>
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom:10px">
						{!! Form::number('bpAM',$po->bpAM,array('class' => 'input-md form-control', 'id'=>'name','step'=>0.001 ,'min'=>1, 'max'=>90, 'readonly')); !!} 
						...
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom: 10px">
						{!! Form::number('waterMax',$po->bpWater,array('class' => 'input-md form-control', 'id'=>'email', 'max'=>10, 'readonly')); !!}
						...
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom:10px">
						{!! Form::number('bpBD',$po->bpDensity,array('class' => 'input-md form-control', 'id'=>'name',  'step'=>0.0001,'max'=>1, 'readonly')); !!} <span>range:0.01-1</span>
						</div>			
					</div>									
...
<hr style="width: 100%; color: black; height: 1px;"/>	
						...
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom: 10px">
						{!! Form::number('fpGran',$po->fpGranular,array('class' => 'input-md form-control', 'id'=>'email', 'min'=>1, 'max'=>5, 'readonly')); !!} <span>range:1-5</span>
						</div>	
					</div>
						<div id="div_id_select" class="form-group required">
						<label for="id_select"  class="control-label col-md-5  requiredField">FP Perfume<span class="asteriskField"></span> </label>
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom: 10px">
						{!! Form::number('fpPerf',$po->fpPerfume,array('class' => 'input-md form-control', 'min'=>1, 'max'=>5,'id'=>'email', 'readonly')); !!} <span>range:1-5</span>
						</div>	
					</div>	
						<div id="div_id_select" class="form-group required">
						<label for="id_select"  class="control-label col-md-5  requiredField">FP %BD (g/cm3)<span class="asteriskField"></span></label>
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom:10px">
						{!! Form::number('fpBD',$po->fpDensity,array('class' => 'input-md form-control', 'id'=>'name',  'step'=>0.0001,  'max'=>1, 'readonly')); !!} <span>range:0.01-1</span>
						</div>	
					</div>				
						<div id="div_id_select" class="form-group required">
						<label for="id_select"  class="control-label col-md-5  requiredField">FP SPOT<span class="asteriskField"></span> </label>
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom: 10px">
						{!! Form::number('fpSpot',$po->fpSpot,array('class' => 'input-md form-control', 'id'=>'email', 'min'=>1, 'max'=>5, 'readonly')); !!}<span>range:1-5</span>
						</div>	
					</div>
						<div id="div_id_select" class="form-group required">
						<label for="id_select"  class="control-label col-md-5  requiredField">FP %AM<span class="asteriskField"></span></label>
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom:10px">
						{!! Form::number('fpAM',$po->fpAM,array('class' => 'input-md form-control', 'id'=>'name', 'step'=>0.001,  'min'=>1, 'max'=>100, 'readonly')); !!} <span>range:1-90</span>
						</div>							
					</div>				
						<div id="div_id_select" class="form-group required">
						<label for="id_select"  class="control-label col-md-5  requiredField">FP %Water (H20)<span class="asteriskField"></span></label>
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom:10px">
						{!! Form::number('fpWater',$po->fpWater,array('class' => 'input-md form-control', 'id'=>'name', 'step'=>0.001,  'min'=>1, 'max'=>100, 'readonly')); !!} <span>range:1-90</span>
						</div>							
					</div>				
						<div id="div_id_select" class="form-group required">
						<label for="id_select"  class="control-label col-md-5  requiredField">FP PH<span class="asteriskField"></span></label>
						<div class="controls col-md-7 col-md-pull-1"  style="margin-bottom:10px">
						{!! Form::number('fpPH',$po->fpPH,array('class' => 'input-md form-control', 'id'=>'name', 'step'=>0.001,  'min'=>1, 'max'=>100, 'readonly')); !!} <span>range:1-90</span>
						</div>							
					</div>	
